...
def generate_report(query: str, filters_dict: dict = None, exact_fir_context: dict = None) -> str:
    ...
    if exact_fir_context:
        ...
        exact_chunk = {
            ...
            "crime_type": exact_fir_context.get("crime_type", "Unknown"),
            "district": exact_fir_context.get("district", "Unknown"),
            "date_filed": exact_fir_context.get("date_filed", "Unknown"),
            "text": exact_fir_context.get("text", f"EXACT MATCHING FIR RECORD:\n{json.dumps(exact_fir_context, indent=2)}"),
